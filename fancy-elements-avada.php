 ...
 * Description: This plugin is built for the Avada theme. It adds new fancy elements to the list of Avada builder elements.
 * Version: 1.0.2
 * Author: WP Square
...
/**
 * Check if FusionBuilder Class exists.
 */
